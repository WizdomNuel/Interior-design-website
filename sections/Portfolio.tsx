...
const Portfolio: React.FC = () => {
  ...
  const allImages = [
    ...
    { src: service3Image, title: "Modern Living Living", description: "Elegant marble surfaces living room with contemporary fixtures and luxury finishes" },
    { src: service4Image, title: "Formal Dining Room", description: "Sophisticated dining space with elegant table and ambient lighting" },
    { src: service5Image, title: "Executive Waiting Room", description: "Professional workspace with ergonomic design and modern amenities" },
    ...
    { src: service01Image, title: "Walk-in Closet", description: "Luxury walk-path solutions with custom organization" },
