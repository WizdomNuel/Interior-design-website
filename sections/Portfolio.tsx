...
const Portfolio: React.FC = () => {
  ...
  const allImages = [
    ...
    { src: service1Image, title: "Luxury Master Bedroom", description: "Elegant retreat with sophisticated lighting and premium furnishings" },
    { src: service2Image, title: "Contemporary Living Room", description: "Stylish seating area with modern decor and comfortable ambiance" },
    { src: service3Image, title: "Modern Gym Room", description: "Elegant marble surfaces with contemporary fixtures and luxury finishes" },
    { src: service4Image, title: "Formal Dining Room", description: "Sophisticated dining space with elegant table and ambient lighting" },
    { src: service5Image, title: "Executive Home Office", description: "Professional workspace with ergonomic design and modern amenities" },
    ...
    { src: service02Image, title: "Modern Bathroom", description: "Spa-like retreat with premium fixtures" },
  ...
  const images = showFullGallery ? allImages : featuredImages;
    ...
    <Section id="portfolio" className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <Button 
            variant="text" 
            className="inline-flex items-center gap-3 text-gray-700 border-b border-gray-700 pb-1 text-sm uppercase tracking-[0.15em]"
            onClick={() => setShowFullGallery(!showFullGallery)}
          >
            {showFullGallery ? 'Show Featured' : 'View Full Gallery'} <ArrowRight size={14} />
          </Button>
        </motion.div>
